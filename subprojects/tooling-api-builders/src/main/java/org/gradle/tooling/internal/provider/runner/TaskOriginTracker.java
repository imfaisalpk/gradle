...
class TaskOriginTracker implements BuildOperationListener {
    ...
    public void started(BuildOperationDescriptor buildOperation, OperationStartEvent startEvent) {
        if (buildOperation.getDetails() instanceof RealizeTaskBuildOperationType.Details) {
            ...
            addOrigin(buildOperation, details.getTaskId());
    ...
    private void addOrigin(BuildOperationDescriptor buildOperation, long taskId) {
        origins.computeIfAbsent(taskId, key -> {
            PluginApplicationTracker.PluginApplication pluginApplication = pluginApplicationTracker.findCurrentPluginApplication(buildOperation.getId());
